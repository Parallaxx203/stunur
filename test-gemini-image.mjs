...
const API_KEY = "llmapi_56e1bcc7d325e1985199f29375d3e2295292fb263de6b678e2b9f8d2a1502eff";
...
const testPrompt = "sitting at a gaming setup with RGB lights, headphones on, smiling for the first time";

console.log("🧪 Testing Gemini 3.1 Flash Image Preview (image generation model)...");
...
try {
  ...
  fs.writeFileSync('/home/claude/stunur/GENERATED_IMAGE_TEST.txt', `${imageUrl}\n\nTest Prompt: ${testPrompt}`, 'utf8');
